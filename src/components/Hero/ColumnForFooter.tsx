...
export const ColumnForFooter = ({miniSections, sectionTitle} : ColumnForFooterProps) => {
  return (
    <div className='flex flex-col items-start justify-start gap-4 py-2 min-h-[250px] '>
                <h2 className='text-lg md:text-2xl max-w-[10ch] lg:max-w-none font-manrope text-left w-full font-semibold '>{sectionTitle}</h2>
                <div className='flex flex-col items-center justify-center gap-2 max-w-[13ch] lg:max-w-[20ch]    '>
