...
export const CardFeaturedCollections = ({
  ...
  return (
    <div
      className={clsx(
        'relative group/card rounded-xl cursor-pointer flex items-end overflow-hidden justify-end min-h-[440px] lg:min-h-[640px]',
        bgColor,
        'shadow-xl rounded-lg',
        `${colSpanMobile} sm:${colSpanMobile} md:${colSpanMobile} lg:${colSpan}` // Clases responsivas para columnas
      )}
    >
      <img
        src={imageSrc}
        ...
        height={imageHeight}
        alt={imageAlt}
        className='absolute rounded-xl inset-0 w-full group-hover/card:scale-110 group-hover/card:blur-sm h-full object-cover transition-transform'
      />
